...
parser.add_argument('--data_dir', default='/Volumes/Coding/HM_caompettion/Our_Own_Code',
                    help="Directory containing the dataset")
parser.add_argument('--model_dir', default='/Volumes/Coding/HM_caompettion/Our_Own_Code',
...
def train(model, optimizer, loss_fn, data_iterator, metrics, params, num_steps):
    ...
    for i in t:
        ...
        labels_batch = train_batch.targets
...
if __name__ == '__main__':
    ...
    #val_data = data['val']
    Data = pickle.load(open("DatasetLoad.pkl","rb"))
    train_data = Data.train_dataset
    val_data = Data.val_dataset

    # specify the train and val dataset sizes
    params.train_size = 8500#train_data['size']
    params.val_size = 500#val_data['size']
    ...
    # model.eval()
    optimizer =torch.optim.Adam(model.parameters(), lr= 1.0e-05, eps=1.0e-08)
