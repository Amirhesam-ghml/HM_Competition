...
def evaluate(model, loss_fn, data_iterator, metrics, params, num_steps):
    ...
    for _ in range(num_steps):
        ...
        labels_batch = data_batch.targets
        # compute model output
        # output_batch = model(data_batch)
        output_batch = model(train_batch.input_ids,
            train_batch.input_mask,
            train_batch.attention_mask,
            train_batch.token_type_ids,
            train_batch.visual_embeddings,
            train_batch.position_embeddings_visual,
            train_batch.visual_embeddings_type,
            train_batch.image_text_alignment,
            train_batch.masked_lm_labels,)
